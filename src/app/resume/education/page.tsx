...
import { GraduationCap, Calendar, MapPin, BookOpen, Award, TrendingUp } from "lucide-react";
  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 -z-10">
        ...
        />
        <motion.div
          className="absolute top-1/3 left-1/4 w-24 h-24 rounded-full bg-gradient-to-br from-primary/5 to-primary/2 blur-2xl"
          animate={{
            y: [0, -30, 0],
            scale: [1, 1.2, 1],
          }}
      ...
      >
        ...
        {education.map((edu, index) => (
          ...
          >
            ...
            >
              <Card className="relative group overflow-hidden hover:shadow-xl transition-all duration-500 border-primary/10 hover:border-primary/30">
